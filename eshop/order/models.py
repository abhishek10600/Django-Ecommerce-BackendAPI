...
class PaytmentStatus(models.TextChoices):
    PAID = "PAID"
    UNPAID = "UNPAID"
...
class Order(models.Model):
    ...
    payment_status = models.CharField(
        max_length=20, choices=PaytmentStatus.choices, default=PaytmentStatus.UNPAID)
    status = models.CharField(
        max_length=50, choices=OrderStatus.choices, default=OrderStatus.PROCESSING)
    payment_mode = models.CharField(
        max_length=20, choices=PaymentMode.choices, default=PaymentMode.COD)
