...
from .views import get_products, get_product, upload_product_images, new_product, update_product, delete_product, create_update_review, delete_review
...
urlpatterns = [
    ...
    path("<str:pk>/reviews/", create_update_review, name="create_update_review"),
